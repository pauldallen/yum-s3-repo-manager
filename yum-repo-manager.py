...
def parseArgs():
    ...
    parser.add_option("-b", "--bucket-name",        dest="yumRepoBucketNames",  default=[], action="append",                     help="The list of names of existing S3 buckets (Can be utilized to mix public and and private repository buckets). *NOTE* all buckets must be in the same region [default: %default]")
